...
- The governed invoke route is wired in CDK as `POST /tenants/{tenantSlug}/invoke` with Cognito authorization and AWS-backed default modes.
...
- Add KMS-backed decision receipt verification.
