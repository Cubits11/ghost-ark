...
- The governed invoke AWS path is a VERIFIED-RUNTIME-SPINE-v0.1 candidate. It is not production-ready after local or live smoke gates.
...
- Broaden Bedrock model request/response adapters beyond the current Anthropic Claude Messages, Amazon Titan Text, Cohere Command/Command R, and Mistral text-instruct support.
