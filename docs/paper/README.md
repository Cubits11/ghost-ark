...
| Test counts (1,244 / 161) — commit-relative, see `main.tex` macro comment | `npm test` at HEAD |
| Claim-gate file count (833) — commit-relative, like the test count | `npm run scan:claims` at HEAD |
