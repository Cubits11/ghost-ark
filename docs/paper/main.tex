...
% Mutant distinct-state counts, from the SAME artifacts/proofs/proofs_summary.json
% as the baselines above. These were inline literals until 2026-08-02 and had
% drifted from the recorded run (61/240/232 against an actual 63/396/221) — the
% macro discipline covered baselines and skipped mutants, so only the mutants rotted.
\newcommand{\plmutstates}{63}
\newcommand{\scmutstates}{396}
\newcommand{\tbmutstates}{22}
\newcommand{\nlmutstates}{221}
% Test suite at HEAD (npm test, 2026-08-02): 1244 passed / 161 files;
% 9 tests in 1 file skipped. Previously recorded as 706/105 and stale by 538 tests
...
% suite as one.
\newcommand{\testcount}{1{,}244}
\newcommand{\testfiles}{161}
% Claim-language gate (npm run scan:claims, 2026-08-02): 833 scannable files, 0 hits.
...
\quad\emph{mutant}         & \plmutstates{} & violation reproduced \\
SpeculativeCollapse        & \scstates{}    & clean \\
\quad\emph{mutant}         & \scmutstates{} & violation reproduced \\
TransportBoundary          & \tbstates{}    & clean \\
\quad\emph{mutant}         & \tbmutstates{} & violation reproduced \\
DAB\_NonceLedger           & \nlstates{}    & clean (incl.\ temporal) \\
\quad\emph{mutant}         & \nlmutstates{} & \texttt{NoReplays} violated \\
