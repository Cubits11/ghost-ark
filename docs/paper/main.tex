...
No live-cloud behavior (KMS-mode signing, cloud latency); no end-to-end
Rust gateway$\leftrightarrow$independent-verifier round-trip (a recorded gap
in the repository inventory); nothing semantic. The reproduction pipeline
