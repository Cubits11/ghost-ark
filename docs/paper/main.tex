...
% Test suite at HEAD (make unit, 2026-07-17): 682 tests / 101 files, all passing
\newcommand{\testcount}{682}
\newcommand{\testfiles}{101}
...
terminates in a signed receipt. Gate~2 (OCC over $\piR$) is specified but not
yet enforced at runtime; gates~1 and~3 are implemented and, for the ledger,
wired from the TLC-verified tombstone model.}
\label{fig:pipeline}
\end{figure}
