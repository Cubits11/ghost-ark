...
- **Which of the 43 research documents matter?** → [RESEARCH_INDEX.json](./docs/research/RESEARCH_INDEX.json) classifies every one as core / supporting / exploratory / process / non-research. Eight are core; 25 supporting, 5 exploratory, 5 process.
